...
- **Docker with external database**: You can run OpenProject with the Docker image and an external PostgreSQL database by setting `DATABASE_URL`. See [Configuring a custom database server](https://www.openproject.org/docs/installation-and-operations/configuration/database/#docker-based-installation).
